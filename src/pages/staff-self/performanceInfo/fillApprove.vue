<template>
  <div class="fillApprove">
    <header id="fillApprove-header">
      <hr-header
        title='指标审核'
    ...
    <div class="fill-body">
      ...
      <section id="fill-section">
        <figure>
          <div id="fillApprove-content" v-if="this.performanceDatas.length != 0" :style="'height:'+ bodyHeight_show">
...
<script>
  ...
  export default {
    ...
    mounted(){
      this.initUserinfo();
      this.initHeight();
      if(this.$route.query.source == 'objectDetailapprove'
    ...
    methods:{
      ...
      inittarget(){
        let _this = this
        fetchData({
          url : 'hrssc/portal/peInfo/fillApprovelist',
          method : 'post',
          mock : false,
          param : {
            pk_schemeperiod: this.pk_schemeperiod
