                                    ...
                                    <div class="itemdiv">
                                        ...
                                        <div class="itemmsgdiv">
                                            <div class="itemmsg">
                                                ...
                                                <span class="psnmobilestyle">{{ data2.postname}}</span>
                                            </div>
    ...
    export default {
        ...
        methods: {
            ...
            loadData: function() {
                ...
                util.ajax('hrssc/portal/psnbase/queryPsnInfoByDeptPk', 'POST', "application/json", param, function(data) {
                    Indicator.close()
            ...
            showDetail: function(pk_psndoc){
                //console.log('pk_psndoc = ' + pk_psndoc);
                this.$router.push({name:'empResumeDetail', query: {pk_psndoc: pk_psndoc}});
            },
