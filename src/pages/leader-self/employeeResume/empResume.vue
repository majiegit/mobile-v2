...
<script>
    ...
    export default {
        ...
        methods: {
            opensearch: function() {
                this.$router.push("/orgSearchBar");
            },
            routerpush: function(deptname, deptid) {
                this.$router.push({name: 'employeeList', query: { deptname: deptname, deptid: deptid}});
            },
            /**
             * 用于缓存当前当前人员权限下的一级组织
             */
             ...
             */
            orgDetail: function() {
                this.$router.push({name: 'orgStructure'});
            },
            goReturn: function() {
                localStorage.removeItem('selOrgHis');
