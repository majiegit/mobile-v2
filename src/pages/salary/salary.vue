<template>
  <div>
    ...
    <van-row type="flex" justify="center" class="header_div">
      <van-col :span="5" class="header_two">薪资期间</van-col>
      <van-col :span="15" class="header_two">
        <van-col :span="10" class="time_div" @click="selectDate('beginDate','开始年月')">
          {{ beginDate }}
        </van-col>
        <van-col :span="4" style="text-align: center;">
          至
        </van-col>
        <van-col :span="10" class="time_div"  @click="selectDate('endDate','结束年月')">
          {{ endDate }}
        </van-col>
      </van-col>
    </van-row>
