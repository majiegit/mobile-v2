<template>
  <div>
    <Header title="调动申请" @clickLeft="clickLeft"></Header>
    <div>
      <div class="item_body">
  ...
  export default {
    ...
    methods: {
      ...
      selectDate(field) {
        ...
        if (this.transData[field]) {
          this.initDate = new Date(this.transData[field])
        }
      ...
      onConfirmDate(value) {
        ...
        this.transData[this.clickDateField] = timeValue
